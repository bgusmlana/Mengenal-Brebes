...
public class Wpanenjoan extends AppCompatActivity {
    private static ViewPager mPager;
    private static int currentPage = 0;
    private static int NUM_PAGES = 0;
    private static final Integer[] IMAGES= {R.drawable.w_panenjoan,R.drawable.w_panenjoan2,R.drawable.w_panenjoan3};
    ...
    Uri gmmIntentUri;
    Intent mapIntent;
    String lok = "-7.139928,108.751030";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wpanenjoan);
        ...
        btn_navigasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mapIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText(Wpanenjoan.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
    ...
    private void init() {
        ...
        mPager.setAdapter(new Slide_adapter(Wpanenjoan.this,ImagesArray));
